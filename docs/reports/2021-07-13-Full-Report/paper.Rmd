...
```{r plot_tbv_site, message=FALSE, warning=FALSE, error=FALSE, echo=FALSE, fig.height=5, fig.width=6, fig.align="center"}
...
```{r plot_tbv, message=FALSE, warning=FALSE, error=FALSE, echo=FALSE, fig.height=5, fig.width=6, fig.align="center"}
...
```{r table_tbv, results="asis", message=FALSE, warning=FALSE, error=FALSE, echo=FALSE}
...
# Per-hemisphere non-infarcted tissue fraction at the early timepoint
...
# Per-hemisphere non-infarcted tissue fraction at the late timepoint
...
# Lesion volume vs midline shift in the early timepoint 
